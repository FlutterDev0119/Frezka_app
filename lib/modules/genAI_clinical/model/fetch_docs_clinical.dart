class FetchDocsClinical {
  ...
  //       'Investigator Analysis': List<String>.from(json['output']['Investigator Analysis'] ?? []),
  //       'Site Analysis': List<String>.from(json['output']['Site Analysis'] ?? []),
  //       'Trial Analysis': List<String>.from(json['output']['Trial Analysis'] ?? []),
  //     } : null,
  //   );
  // }
  factory FetchDocsClinical.fromJson(Map<String, dynamic> json) {
