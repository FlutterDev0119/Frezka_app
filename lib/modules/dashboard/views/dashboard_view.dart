...
//   AppBar _buildAppBar() {
//     return AppBar(
//       title: Text("Dashboard", style: GoogleFonts.roboto(color: Colors.white)),
...
//           _buildDrawerItem(Icons.local_hospital_rounded, "GenAI Clinical",
//               '/GenAI_Clinical'),
...
//       {Color color = Colors.blue, bool isLogout = false}) {
//     return ListTile(
