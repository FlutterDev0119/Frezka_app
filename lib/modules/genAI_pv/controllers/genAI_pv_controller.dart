  ...
  Future<void> additionalNarrative({
    ...
    try {
      ...
      void printLongText(String text) {
        final pattern = RegExp('.{1,800}'); // 800 is safe for most IDEs
        pattern.allMatches(text).forEach((match) => print(match.group(0)));
      }

// Usage:
      printLongText(request.toString());
  ...
  Future<void> narrativeGeneration({
    ...
    try {
      ...
      final request = {
        // "query": query,
        "SafetyReport"://["PatientID,AdverseEventTerm,Severity,Outcome,Hospitalized,LifeThreatening,DrugName,DrugDosage,DrugStartDate,DrugEndDate,FollowUpDate,Age,Gender,ReporterType,BatchNumber\r\n10001,Headache,Moderate,Recovered,No,No,Aspirin,50 mg,01-01-2025,10-01-2025,10-01-2025,45,20,Physician,AB1234\r\n10002,Nausea,Severe,Ongoing,No,Yes,Paracetamol,500 mg,05-01-2025,12-01-2025,12-01-2025,30,Female,Patient,CD5678\r\n10003,Dizziness,Mild,Recovered,No,No,Ibuprofen,200 mg,03-01-2025,15-01-2025,15-01-2025,28,Male,Nurse,EF9012\r\n10004,Fatigue,Moderate,Ongoing,No,No,Omeprazole,10 mg,07-01-2025,14-01-2025,14-01-2025,60,Female,Physician,GH3456\r\n10005,Cough,Mild,Recovered,No,No,Amoxicillin,250 mg,02-01-2025,13-01-2025,13-01-2025,55,Female,Patient,IJ6789\r\n10006,Rash,Moderate,Recovered,No,Yes,Metformin,500 mg,01-01-2025,18-01-2025,18-01-2025,50,Male,Physician,KL1234\r\n10007,Swelling,Severe,Ongoing,Yes,Yes,Lisinopril,10 mg,05-01-2025,20-01-2025,20-01-2025,40,Female,Nurse,LM2345\r\n10008,Diarrhea,Mild,Recovered,No,No,Ibuprofen,400 mg,08-01-2025,21-01-2025,21-02-2025,35,Male,Physician,NO4567\r\n10009,Back pain,Moderate,Recovered,No,No,Morphine,10 mg,03-01-2025,22-01-2025,22-01-2025,60,Female,Patient,OP6789\r\n10010,Nausea,Severe,Recovered,No,No,Paracetamol,500 mg,06-01-2025,23-01-2025,23-01-2025,40,Female,Physician,PQ1234\r\n10011,Headache,Moderate,Recovered,No,No,Aspirin,50 mg,01-01-2025,25-01-2025,25-01-2025,29,Male,Nurse,RS4567\r\n10012,Fatigue,Moderate,Recovered,No,No,Paracetamol,500 mg,03-01-2025,26-01-2025,26-01-2025,45,Female,Patient,ST2345\r\n10013,Back pain,Mild,Recovered,No,No,Naproxen,250 mg,04-01-2025,27-01-2025,27-01-2025,38,Male,Physician,UV3456\r\n10014,Diarrhea,Severe,Recovered,Yes,No,Metformin,500 mg,02-01-2025,28-01-2025,28-01-2025,60,Female,Nurse,WX5678\r\n10015,Cough,Severe,Ongoing,No,Yes,Amoxicillin,250 mg,07-01-2025,29-01-2025,29-01-2025,25,Male,Patient,YZ1234"],
        genAIDropdownValue.value == 'Upload File' ? [uploadContent.value.toString()] : safetyReport,
        "prompt": "",
        "checkbox": checkbox,
        "userId": id,
        "user_name": Fullname,
        // "task_id": "b1389b07-5a3c-4dd3-8dbe-4753937a80ae"
        // "SafetyReport": [
        //   "PatientID,AdverseEventTerm,Severity,Outcome,Hospitalized,LifeThreatening,DrugName,DrugDosage,DrugStartDate,DrugEndDate,FollowUpDate,Age,Gender,ReporterType,BatchNumber\r\n10001,Headache,Moderate,Recovered,No,No,Aspirin,50 mg,01-01-2025,10-01-2025,10-01-2025,45,20,Physician,AB1234\r\n10002,Nausea,Severe,Ongoing,No,Yes,Paracetamol,500 mg,05-01-2025,12-01-2025,12-01-2025,30,Female,Patient,CD5678\r\n10003,Dizziness,Mild,Recovered,No,No,Ibuprofen,200 mg,03-01-2025,15-01-2025,15-01-2025,28,Male,Nurse,EF9012\r\n10004,Fatigue,Moderate,Ongoing,No,No,Omeprazole,10 mg,07-01-2025,14-01-2025,14-01-2025,60,Female,Physician,GH3456\r\n10005,Cough,Mild,Recovered,No,No,Amoxicillin,250 mg,02-01-2025,13-01-2025,13-01-2025,55,Female,Patient,IJ6789\r\n10006,Rash,Moderate,Recovered,No,Yes,Metformin,500 mg,01-01-2025,18-01-2025,18-01-2025,50,Male,Physician,KL1234\r\n10007,Swelling,Severe,Ongoing,Yes,Yes,Lisinopril,10 mg,05-01-2025,20-01-2025,20-01-2025,40,Female,Nurse,LM2345\r\n10008,Diarrhea,Mild,Recovered,No,No,Ibuprofen,400 mg,08-01-2025,21-01-2025,21-02-2025,35,Male,Physician,NO4567\r\n10009,Back pain,Moderate,Recovered,No,No,Morphine,10 mg,03-01-2025,22-01-2025,22-01-2025,60,Female,Patient,OP6789\r\n10010,Nausea,Severe,Recovered,No,No,Paracetamol,500 mg,06-01-2025,23-01-2025,23-01-2025,40,Female,Physician,PQ1234\r\n10011,Headache,Moderate,Recovered,No,No,Aspirin,50 mg,01-01-2025,25-01-2025,25-01-2025,29,Male,Nurse,RS4567\r\n10012,Fatigue,Moderate,Recovered,No,No,Paracetamol,500 mg,03-01-2025,26-01-2025,26-01-2025,45,Female,Patient,ST2345\r\n10013,Back pain,Mild,Recovered,No,No,Naproxen,250 mg,04-01-2025,27-01-2025,27-01-2025,38,Male,Physician,UV3456\r\n10014,Diarrhea,Severe,Recovered,Yes,No,Metformin,500 mg,02-01-2025,28-01-2025,28-01-2025,60,Female,Nurse,WX5678\r\n10015,Cough,Severe,Ongoing,No,Yes,Amoxicillin,250 mg,07-01-2025,29-01-2025,29-01-2025,25,Male,Patient,YZ1234"
        // ],
        // "prompt": "",
        // "checkbox": [
