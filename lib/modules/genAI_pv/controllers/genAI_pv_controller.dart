...
class GenAIPVController extends GetxController {
  ...
  Future<void> narrativeGeneration({required List<String> SafetyReport, required String prompt, required List<String> checkbox, required String userId, required String userName}) async {
    try {
      isLoading.value = true;
